package net.techpda.rxmvvmjavajavatest2.ui.detail;
...
import net.techpda.rxmvvmjavajavatest2.data.model.Repo;
...
public class DetailsViewModel extends ViewModel {
    ...
    private final net.techpda.rxmvvmjavajavatest2.viewmodel.data.rest.RepoRepository repoRepository;
    ...
    @Inject
    public DetailsViewModel(net.techpda.rxmvvmjavajavatest2.viewmodel.data.rest.RepoRepository repoRepository) {
